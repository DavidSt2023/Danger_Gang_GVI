...
-- Lehrer
INSERT INTO Lehrer
    (lehrerKuerzel, nachname, telefonNr, geburtsdatum, nationalitaet)
VALUES
...
INSERT INTO Stundenplan
    (klassenID, lehrerID, fachBereichID, datum, stunde, raumID)
VALUES
...
-- Noten
INSERT INTO Noten
    (schuelerID, fachID, notenartID, zeitpunkt, note)
VALUES
    (1, 1, 1, '2024-01-15', 'A'),
    (2, 2, 2, '2024-01-20', 'B+'),
    (3, 3, 3, '2024-01-25', 'A+'),
